...
def test_ordering_example_class_level(testdir):
    """Make sure that pytest accepts our fixture."""
    ...
    testdir.makepyfile(test_example="""
        ...
        @parameter_priority(2)
        @pytest.fixture(scope="class", params=["a", "b", "c"])
        def letter(request):
            return request.param
        ...
        @parameter_priority(1)
        @pytest.fixture(scope="class", params=["red", "green", "blue"])
        def color(request):
            return request.param
        ...
        class Test:
            def test_one(self, intermediate_step):
                pass

            def test_two(self, intermediate_step):
                pass
    """)
